...
function loadDatabase() {
  const localCustomers = localStorage.getItem('stitchflow_customers');
  const localOrders = localStorage.getItem('stitchflow_orders');
  ...
  if (!localStorage.getItem('stitchflow_seeded_50')) {
    generateFiftyCustomers();
    localStorage.setItem('stitchflow_seeded_50', 'true');
  }
}
...
function saveDatabase() {
  localStorage.setItem('stitchflow_customers', JSON.stringify(state.customers));
  localStorage.setItem('stitchflow_orders', JSON.stringify(state.orders));
}
